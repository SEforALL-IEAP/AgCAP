...
# settles_gdf_analyzed_path= project_root / 'data/processed/settles_gdf_MDG_analyzed.gpkg'
# print(f'The target dataset path is: {settles_gdf_analyzed_path}')
...
# # Alternatively, set to WARNING to only show serious errors, or CRITICAL
...
# # Run the app
# viz_results.run(jupyter_mode='tab', port=8057)
